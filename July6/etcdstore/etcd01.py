...
def main():
    ...
    # issue an HTTP PUT transaction to store our data within /keys/requess
    ...
    # r is the response code resulting from the PUT
    r = requests.put('http://127.0.0.1:2379/v2/keys/requests', data={'value': 'http for humans, v2'})
